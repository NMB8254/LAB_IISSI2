    ...
    */
    ...
    await queryInterface.bulkInsert('Restaurants',
      [
        ...
        { name: '100 montaditos', description: 'A fun and varied way to enjoy food. A place to share experiences and get carried away by the moment.', address: 'Józefa 34, Kraków, Poland', postalCode: '123-4567', logo: 'public/restaurants/100MontaditosLogo.jpeg', restaurantCategoryId: 2, shippingCosts: 1.5, email: 'info@restaurant.com', phone: '+48123456789', createdAt: new Date(), updatedAt: new Date(), userId: 2, status: 'online' },
